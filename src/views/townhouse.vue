...
.then(data => localStorage.setItem('houseData1', JSON.stringify(data)));
const savedData1 = JSON.parse(localStorage.getItem('houseData1'));


const finaldata = {"townhouses": savedData1}
